...
public class UtenteCreatoreDTO {
		...
		public UtenteCreatoreDTO() {
			super();
		}

		public UtenteCreatoreDTO(Long id,
		...
		// niente password...
		public static UtenteCreatoreDTO buildUtenteDTOFromModel(Utente utenteModel) {
			UtenteCreatoreDTO result = new UtenteCreatoreDTO(utenteModel.getId(), utenteModel.getUsername(), utenteModel.getNome(),
